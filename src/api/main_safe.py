...
# Import routers (import only the ones that don't require face-recognition)
from .routers import auth, content, rag
# Conditionally import vision router
try:
...
# Include vision router only if available
if VISION_AVAILABLE:
    app.include_router(vision_router, prefix="/api/vision", tags=["vision"])
else:
    @app.get("/api/vision/status")
    def vision_status():
        return {"status": "not_available", "message": "Vision module not available due to missing dependencies"}
