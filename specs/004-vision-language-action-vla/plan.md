...
- preferences: object (personalization settings)
- moduleProgress: object (progress tracking per module)
...
**Content API** (Docusaurus):
```
GET /api/content/{moduleId}/{chapterId}
- Response: {content, urduContent, metadata}

GET /api/content/search
- Query: {q, lang?}
- Response: {results: [{id, title, snippet, score}]}
```
