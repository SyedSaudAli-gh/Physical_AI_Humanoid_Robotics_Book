...
- Review the implementation plan in `specs/004-vision-language-action-vla/plan.md`
- Consult the API contracts in `specs/004-vision-language-action-vla/contracts/`
- Review the data model in `specs/004-vision-language-action-vla/data-model.md`
